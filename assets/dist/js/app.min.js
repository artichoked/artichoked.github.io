...
class Search{constructor(){this.apiURL="https://www.googleapis.com/books/v1/volumes",this.parameters={filter:"full",maxResults:12,q:null,apiKey:"AIzaSyCm0v_8QzEma6Es_yqJdw42W4PbvqFjOKM"},this.results=null,this.elements={form:$("#search-form"),queryInput:$("#query"),results:$("#results"),subtitle:$("#main-thing p"),title:$("#main-thing h1"),body:$("body"),titleID:$("#title-id"),viewDiv:$("#view-div"),otherButtons:$("#other-buttons a"),again:$("#again"),back:$("#back"),loading:$("#loading")},this.viewer=null}init(){this.elements.otherButtons.hide(),this.elements.results.hide(),this.elements.viewDiv.hide(),this.getInput(),google.books.load()}getInput(){this.elements.form.on("submit",e=>{e.preventDefault(),this.parameters.q=this.elements.queryInput.val().trim(),console.log(this.parameters.q),this.getResultsByQuery()})}getResultsByQuery(e){$.getJSON(this.apiURL,this.parameters).done(e=>{console.log(e),this.displayResults(e)})}displayResults(e){this.hideForm(),e.items.forEach(e=>{const t=e.volumeInfo.title,s=e.volumeInfo.authors,i=e.volumeInfo.description,l=e.volumeInfo.imageLinks.thumbnail;let n=e.id;this.elements.results.append(`<div class="col col-sm-6 col-md-4 col-lg-3">\n          <div class="card" data-gbid="${n}">\n            <div id="thumbnail-link">\n             <img src=${l} alt="thumbnail">\n            </div>\n              <h4 class="card-title">${t}<br>\n              By ${s}</h4>\n            <p class="card-text">${i}</p>\n          </div>\n        </div>`)}),this.elements.results.delay(350).fadeIn(800),this.openPreview()}hideForm(){this.elements.body.css({"background-image":'url("../../../assets/dist/img/background-blank.png")'}),this.elements.form.fadeOut(300),this.elements.subtitle.fadeOut(300),this.elements.again.append("AGAIN!"),$(window).width()>768&&this.elements.titleID.animate({left:"-=29vw"},800),this.elements.otherButtons.fadeIn(2800)}openPreview(){$(".card").on("click",e=>{e.preventDefault();const t=$(e.currentTarget).data("gbid");this.elements.viewDiv.show(),this.elements.results.hide(),this.preview(t)})}preview(e){this.viewer=new google.books.DefaultViewer(document.querySelector("#view-div")),this.viewer.load(e,null,()=>{this.elements.loading.hide(),window.setTimeout(()=>{this.elements.back.append("back to results")},500)})}}const createSearch=new Search;createSearch.init();